...
@st.cache_data
def load_data():
        engine = create_engine("mssql+pymssql://admin:Streamlit123.@ecommerce-db.c9ycgk8s81st.eu-north-1.rds.amazonaws.com:1433/E-commerce")
...
# USERS & BUYERS
        ...
        avg_sessions_per_user = round(total_sessions/Total_users,2)
